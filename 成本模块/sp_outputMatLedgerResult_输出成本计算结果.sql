...
BEGIN      
 ...
 BEGIN      
  ...
  FROM istockledgerlog d with(nolock) inner join iserieslogitem a on d.doccode=a.doccode AND d.MatCode=a.matcode1 AND a.DocCode=@doccode AND d.indigit<0    
  ...
  FROM istockledgerlog d with(nolock) inner join iserieslogitem a on d.doccode=a.doccode AND d.MatCode=a.matcode1 AND a.DocCode=@doccode AND d.outdigit<>0    
 END      
 ...
 BEGIN      
  ...
  FROM istockledgerlog d with(nolock) inner join iserieslogitem a on d.doccode=a.doccode AND d.MatCode=a.matcode AND a.DocCode=@doccode AND d.indigit>0      
 END       
END              
