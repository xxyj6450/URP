...
BEGIN                    
 UPDATE imatdoc_d SET rateprice=(isnull(a.RateValue,0)-isnull(a.OldRateValue,0))/isnull(a.Digit,0),ratemoney =isnull( a.RateValue,0)-isnull(a.OldRateValue,0)                   
...
BEGIN                    
 UPDATE imatdoc_d SET rateprice = (isnull(a.OldRateValue,0)-isnull(a.RateValue,0))/isnull(a.Digit,0),ratemoney = isnull(a.OldRateValue,0)-isnull(a.RateValue,0)                     
 FROM imatdoc_d d with(nolock) inner join #XMLDataTable a on d.rowid=a.RowID AND d.MatCode=a.Matcode AND d.DocCode=@doccode            
...
IF @formid IN (4630)                    
BEGIN                    
 UPDATE Commsales_d SET rateprice = (isnull(a.RateValue,0)-isnull(a.OldRateValue,0))/isnull(a.Digit,0),            
...
IF @formid IN (4631)                    
BEGIN                    
 UPDATE Commsales_d SET rateprice = (isnull(a.OldRateValue,0)-isnull(a.RateValue,0))/isnull(a.Digit,0),            
...
BEGIN              
 IF @OptionID='1'            
 BEGIN            
  UPDATE iserieslogitem SET rateprice = abs(isnull(a.RateValue,0)-isnull(a.OldRateValue,0))/isnull(a.Digit,0),ratemoney = abs(isnull(a.RateValue,0)-isnull(a.OldRateValue,0))            
 ...
 IF @OptionID='2'            
 BEGIN            
  UPDATE iserieslogitem SET rateprice1 = abs(isnull(a.RateValue,0)-isnull(a.OldRateValue,0))/isnull(a.Digit,0),ratemoney1 = abs(isnull(a.RateValue,0)-isnull(a.OldRateValue,0))                    
...
BEGIN                    
 UPDATE spickorderitem SET rateprice = abs(isnull(a.RateValue,0)-isnull(a.OldRateValue,0))/isnull(a.Digit,0),ratemoney =abs(isnull(a.RateValue,0)-isnull(a.OldRateValue,0))                    
...
BEGIN                    
 UPDATE istockledgerlog SET inrateamount=isnull(a.RateValue,0)-isnull(a.OldRateValue,0)                  
...
BEGIN                    
 UPDATE istockledgerlog SET inrateamount=-1*(isnull(a.OldRateValue,0)-isnull(a.RateValue,0)),periodid=@periodid,docdate=@DocDate                    
 FROM istockledgerlog d with(nolock) inner join #XMLDataTable a on d.docrowid=a.RowID AND d.MatCode=a.Matcode AND d.DocCode=@doccode              
END        
        
IF @formid IN (4631)        
BEGIN        
 UPDATE istockledgerlog SET outrateamount=abs(isnull(a.OldRateValue,0)-isnull(a.RateValue,0)),periodid=@periodid,docdate=@DocDate              
 FROM istockledgerlog d with(nolock) inner join #XMLDataTable a on d.docrowid=a.RowID AND d.MatCode=a.Matcode AND d.DocCode=@doccode          
END                  
                    
IF @formid IN (1523,1501,1598,2401,2419,2450,4950,4031,2424) --贷方正                    
BEGIN                    
 UPDATE istockledgerlog SET outrateamount=isnull(a.OldRateValue,0)-isnull(a.RateValue,0),periodid=@periodid,docdate=@DocDate                    
 FROM istockledgerlog d with(nolock) inner join #XMLDataTable a on d.docrowid=a.RowID AND d.MatCode=a.Matcode AND d.DocCode=@doccode  
...
BEGIN         
 UPDATE istockledgerlog SET outrateamount=-1*(isnull(a.RateValue,0)-isnull(a.OldRateValue,0))
 FROM istockledgerlog d with(nolock) inner join #XMLDataTable a on d.docrowid=a.RowID AND d.MatCode=a.Matcode AND d.DocCode=@doccode                   
...
BEGIN            
 ...
 IF @OptionID='1'            
 BEGIN            
  UPDATE  istockledgerlog  SET inrateamount= -1*isnull(a.ratemoney,0)                  
 ...
 IF @OptionID='2'            
 BEGIN            
  UPDATE  istockledgerlog  SET inrateamount= isnull(a.ratemoney1,0)                    
